...
int call_trans2findfirst(char *inbuf, char *outbuf, int bufsize, int cnum,char **pparams, char **ppdata);
...
BOOL name_query(char *inbuf,char *outbuf,char *name,struct in_addr to_ip,struct in_addr *ip,int maxtime,void (*fn)());
...
int construct_datagram(char *,int,int,int,struct in_addr *,int,char *,char *);
