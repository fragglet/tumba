...
#define ERRSRV 0x02 /* Error is generated by server network file manager. */
...
#define SMB_LKOFF(buf, indx)                                                   \
	(*(uint32 *) (((char *) (buf)) + 2 + (10 * (indx))))
#define SMB_LKLEN(buf, indx)                                                   \
	(*(uint32 *) (((char *) (buf)) + 6 + (10 * (indx))))
